...
/**
 * contains cube instances in a hash map. reevaluates their data every time they
 * change.
 */
@Slf4j
public class CubeRepository implements FigureRepository<Cube> {
	...
	/**
	 * cube data storage. access by id.
	 */
	...
	/**
	 * adds cube to repository. creates cube data associated tho the cube.
	 * 
	...
	/**
	 * update method. called each any registered cube changes.
	 * 
	 * @param id object id.
	 */
	@Override
